    ...
    if (message.content.startsWith("/stunda")) {
      ...
      const stundaEmbed = {
        ...
        footer: {
          text: "leprikons @ 2021",
          icon_url:
            "https://media.discordapp.net/attachments/806122097734451220/806188966570229790/c1073552d7dbea3da1b605de2d7c4ff6.png",
        },
      };
  ...
  if (message.author.id === "482586747201519617") {
    if (message.content.startsWith("/eikt")) {
      ...
      const embed = new Discord.MessageEmbed()
        .setThumbnail(
          "https://lh3.googleusercontent.com/proxy/bk3MS2-oJeoNu4GPT6-Cvn5GTt6q8MmO6gohbTYLBFVg1pl-wjBBTlX4NPjxJgDCe3Kpx6yoQesCSjF7wDkwovii2ichXU-BuAFeo1CIJ_d5"
        )
        .setTitle("EIKT nozares tehnisko darbu pamatiemaņas PA2")
        .setAuthor("TIEŠSAISTES STUNDA")
        .setURL(
          "https://us05web.zoom.us/j/86872407614?pwd=L1FtejhWTG1IZjZPelV4ekxWYnd1QT09"
        )
        .setFooter("ID: 868 7240 7614, Passcode: zdXF4Z")
        .addFields(
          {
            name: "SĀKUMS: 13:30",
            value: "Lai pievienotos stundai, spied uz zili iekrāsotā teksta",
            inline: true,
          },
...
function dm(message) {
  var admin = [
    ...
    "482586747201519617",
    "290452091946663936",
  ]; //can dm users via bot, using the /dm command
      ...
      client.users
        ...
        .catch((err) => {
          if (err === "DiscordAPIError: 404: Not Found") {
            message.channel.send(
              "❗ Something went wrong! Refer to the error log below.\n\n``User with this ID hasn't been found! Error:\n" +
                err +
                "``"
            );
          } else {
...
async function issuefine(message) {
  if (message.channel.id == "799266353999642664") {
    ...
    const fineEmbed = new Discord.MessageEmbed()
      ...
      .setDescription(
        "Sastādīts Luganes pilsētā, Šautuves ielā 2, " +
          yyyy +
          ". gada " +
          dd +
          ". " +
